...
def get_config(arg_list):
    ...
    parser.add_argument('--train_root',
                        help='root directory for loading training data',
                        type=str,
                        )

    parser.add_argument('--val_root',
                        help='root directory for loading validation data',
                        type=str,
                        )

    parser.add_argument('--test_root',
                        help='root directory for loading test data',
                        type=str,
                        )
...
def load_config(curr_config: Optional[ModelConfig] = None, config_path: Optional[str] = None,
    ...
    return ModelConfig(**load_kwargs)
